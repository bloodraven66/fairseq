...
wav2vec2_path=/home1/Sathvik/fairseq_models/librilight_checkpoints/checkpoint_best_10h_default_adapter_ft-on-adapter64-ssl-librilight-10h-adapter-only-pretraining.pt
